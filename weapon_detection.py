...
while True:
    ...
    if confirmed_weapon and not screenshot_taken:
        ...
        filename = f"screenshots/weapon_{datetime.datetime.now().strftime('%H%M%S')}.jpg"
    ...
    if confirmed_weapon and not recording:
        ...
        video_path = f"recordings/detection_{datetime.datetime.now().strftime('%H%M%S')}.avi"
